...
class gps_t(object):
    __slots__ = ["timestamp", "latitude", "latitude_s", "longitude", "longitude_s", "altitude", "altitude_s", "utm_latitude", "utm_longitude", "zone", "zoneLetter"]
    ...
    def __init__(self):
        ...
        self.altitude = 0.0
        self.altitude_s = ""
        self.utm_latitude = 0.0
        self.utm_longitude = 0.0
        self.zone = 0
        self.zoneLetter = ""
    ...
    def _encode_one(self, buf):
        ...
        buf.write(b"\0")
        buf.write(struct.pack(">ddh", self.utm_latitude, self.utm_longitude, self.zone))
    ...
    def _decode_one(buf):
        ...
        self.utm_latitude, self.utm_longitude, self.zone = struct.unpack(">ddh", buf.read(18))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x651b368fafff2d3e) & 0xffffffffffffffff
